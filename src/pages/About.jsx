...
import About_snakebite from '../components/About/About_snakebite'
import Stories_card from '../components/About/Stories_card'
import Peoples_thoughts from '../components/About/Peoples_thoughts'
        ...
        <Page>
            ...
            <div className="bg_lightGrey">
                <div className="container mx-auto px-4 py-10 md:py-20">
                    <h1 className="flex items-center flex-col md:flex-row font-bold text-xl md:mt-10">OUR STORIES <span className="font-black mx-2 hidden md:block">|</span> <button className="btn-outline-primary mt-2 md:mt-0">View All</button></h1>
                    <div className="flex justify-center">
                        <div className="grid md:grid-cols-4 gap-10 mt-10">
                            <Stories_card date="June 23 2021" title="International Conference in Kathmandu 2019" />
                            <Stories_card date="June 23 2021" title="International Conference in Kathmandu 2019" />
                            <Stories_card date="June 23 2021" title="International Conference in Kathmandu 2019" />
                            <Stories_card date="June 23 2021" title="International Conference in Kathmandu 2019" />
                            <Stories_card date="June 23 2021" title="International Conference in Kathmandu 2019" />
                ...
                <div className="grid md:grid-cols-3">
                    <div className="col-span-2">
                        <p className="text-primary font-semibold">OUR HISTORY</p>
                            <div className="text-xl font-bold mt-1">Connecting Dots of SNAKEBITE NEPAL</div>
                    ...
                    <div className="mt-4 w-80 md:w-full">
                        <Peoples_thoughts name="Mr. Sital" content="identifying venomous snakes; the clinical presentation of snakebite and pathophysiology" />
                        <Peoples_thoughts name="Mr. Ravi" content="identifying venomous snakes; the clinical presentation of snakebite and pathophysiology" />
                        <Peoples_thoughts name="Mr. Aatmaram" content="identifying venomous snakes; the clinical presentation of snakebite and pathophysiology" />
            ...
            <div className="container mx-auto px-4 mt-10 md:mt-20 px-8 md:px-4 mb-10 md:mb-32">
                    <h1 className="flex items-center font-bold text-xl md:mt-10 mb-10">Sponsers & Promoters</h1>
                    <Sponsers />
            </div>
