...
function Snakes_and_snakebites() {
    return (
        ...
        <div className="container mx-auto px-4">
            <h1 className="text-xl md:text-2xl font-bold mt-10">VANEMOUS SNAKES IN NEPAL</h1>
            ...
            <div className="grid md:grid-cols-3 my-10">
                ...
                <div className="col-span-2">
                    <Snakebite img="https://www.sciencenewsforstudents.org/wp-content/uploads/2021/01/010821_mt_climbing-snakes_feat-1030x580.jpg"
                    title="Rattlesnakes"
