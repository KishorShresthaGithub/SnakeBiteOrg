...
function Home() {
    const newsData=[
        ...
        },
        {
            date:'19 June 2021',
            category:'research',
            title:'Researchers Find 2 New Multi Drug-Resistant Bacteria In Scat Of "Vine Snake"'
        },
        {
            date:'18 June 2021',
            category:'snakebites',
            title:'Snake bite is a neglected public health issue in many tropical and subtropical countries.'
        }
    ]
    const snakesData=[
        {
    ...
    return (
        <div>
            ...
            <div className="bg_lightGrey py-10 md:py-20">
                <h1 className="font-bold text-4xl  text-center mb-10">LET'S CONNECT </h1>
                <ContactForm />
            </div>
            {/* contact us ends  */}
