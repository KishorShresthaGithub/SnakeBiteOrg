        ...
        <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 my-10">
                ...
                <div className="col-span-2 ">
                    ...
                    <p className="py-2 flex items-center"><BiTime className="mr-2" /> <p className='mr-2'>June 2, 2021</p><BiNews className='mr-2' /><p>News Category</p></p>
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRk67AnSJe-2Ltqbw2ULvam_u_P3gktDsLOzYiW0_w5O9OSygBCvjH_7AXZj9wJF9Ks-d8&usqp=CAU" 
