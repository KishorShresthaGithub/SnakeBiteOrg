    ...
    <Page>
      <div className="" style={{ zIndex: "-10" }}>
        <div className="w-full h-96 relative" style={{ zIndex: "-1" }}>
          <iframe
            title="contact-map"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3531.856579661726!2d85.32444601453862!3d27.721714131468364!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb196dbd2b0f61%3A0xb394bc8610c6459!2sTrioPlus%20Technology%20Pvt.%20Ltd.!5e0!3m2!1sen!2snp!4v1624424132230!5m2!1sen!2snp"
      ...
      <div
        className=" md:container md:mx-auto md:px-4 -mt-52 pb-20 pt-10"
        style={{ zIndex: "100" }}
      >
          ...
          <div className="grid md:grid-cols-3">
            ...
            <div className="bg-yellow-500 p-4 md:p-10">
              ...
              <div className="flex items-center text-xl text-white py-2">
                <FaPhoneAlt />{" "}
                <p className="font-md ml-2">+977-01249340 | 9892428389</p>
              </div>
              <div className="flex items-center text-xl text-white py-2">
                <FiMail />{" "}
                <p className="font-md ml-2">info@snakebitenepal.com</p>
              </div>
