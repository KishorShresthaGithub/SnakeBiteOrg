        ...
        <div className="bg-gray-100 min-h-screen md:px-6 md:py-8">
            <div className="card shadow-md bg-white">
                ...
                <div className="flex items-center">
                    <div className={activeBtn=='Add'?'flex items-center border-2 border-gray-100 cursor-pointer p-4 md:p-8 bg-gray-200': "flex items-center border-2 border-gray-100 cursor-pointer p-4 md:p-8" }
                    onClick={()=>{setActiveBtn('Add')}}>
                        <IoMdAdd />
                        {props.btnAdd}
                    </div>
                    <div className={activeBtn=='View'?'flex items-center border-2 border-gray-100 cursor-pointer p-4 md:p-8 bg-gray-200': "flex items-center border-2 border-gray-100 cursor-pointer p-4 md:p-8" }
