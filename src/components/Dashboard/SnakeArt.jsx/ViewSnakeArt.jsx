        ...
        <table className=" border-collapse border border-green-800 table-auto text-left w-full">
            ...
            <tbody>
                <tr className="">
                    ...
                    <td  className="border border-gray-200 p-2"><img src="https://images.pexels.com/photos/87428/basilisk-rattlesnake-rattlesnake-snake-viper-87428.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
                    className="max-w-xs" alt="" /></td>
