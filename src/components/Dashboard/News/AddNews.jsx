        ...
        <form action="">
            <div className="w-80 md:w-full md:flex my-2">
               ...
               <div className="flex flex-col mb-2 card px-2 w-full py-4 ">
                    ...
                    <select name="" id="sCategory" className="md:w-80 p-2 border-2 border-gray-100 rounded">
            ...
            <div className="flex flex-col mr-4 px-2 py-2">
                    ...
                    <input type="text" name="" id="title" className="md:w-full p-2 border-2 border-gray-100 rounded" />
            </div>

            <div className="flex flex-col mb-2 mr-4 px-2 py-2">
                    <label htmlFor="img">Add News Title Image</label>
                    <input type="file" name="" id="img" className="w-80 p-2 border-2 border-gray-100 rounded" />
            </div>
