    ...
    return (
        <table className=" border-collapse border border-green-800 table-auto text-left w-full">
            <thead className="">
                ...
                <th className="border border-gray-200 p-2">News Title</th>
                <th className="border border-gray-200 p-2">News Category</th>
            ...
            <tbody>
                <tr className="">
                    ...
                    <td  className="border border-gray-200 p-2">This is the sankebite news title</td>
